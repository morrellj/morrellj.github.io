...
let additionalAssessmentData = {
  additionalAssessmentsCompleted: {
    ...
    selectOptions: [
      ...
      "Continence Assessment scale completed",
      "Depression screening completed.",
      "Falls Risk for Older People - community setting completed.",
      "Functional ADL assessment completed.",
      "Hierarchic Dementia Scale asessment completed.",
      "Medication self management assessment completed.",
      "MMSE completed.",
      "Pain assessment completed.",
      "Pressure injury risk assessment completed.",
      "Psychogeriatric Assessment scale completed",
    ],
  },
  additionalAssessmentsRequired: {
    ...
    selectOptions: [
      ...
      "Continence Assessment scale required",
      "Depression screening required.",
      "Falls Risk for Older People - community setting required.",
      "Functional ADL assessment required.",
      "Hierarchic Dementia Scale asessment required.",
      "Medication self management assessment required.",
      "MMSE required.",
      "Pain assessment required.",
      "Pressure injury risk assessment required.",
      "Psychogeriatric Assessment scale required",
    ],
  },
